...
const regionCssMap: { [key: string]: string } = {
  EW: "amber lighten-3 black--text",
  ShB: "grey darken-2 white--text",
  SB: "red darken-2 white--text",
  HW: "indigo darken-2 white--text",
  LaNoscea: "red lighten-2 black--text",
  Gridania: "yellow lighten-2 black--text",
  Thanalan: "brown lighten-2 black--text",
...
const weatherRegions: IRegionData[] = [
  {
    key: "EW",
    zoneIds: [
      956,
